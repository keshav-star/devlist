...
export function AddVideoForm({
  ...
  const handleAddVideo = async () => {
    ...
    try {
      ...
      const response = await addVideoToPlaylist(selectedPlaylistId, {
        title: videoTitle,
        youtubeId,
        note: videoNote.trim(),
      });
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-indigo-50 via-white to-purple-50 border border-gray-200/50 shadow-2xl">
        ...
        <div className="relative p-8 lg:p-12">
          ...
          <div className="text-center mb-8">
            ...
            >
              Organize your YouTube videos with ease and track your learning
              progress
            </motion.p>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <Button
                  ...
                  disabled={!selectedPlaylistId || !videoUrl.trim()}
