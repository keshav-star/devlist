              ...
              <div className="space-y-6">
                ...
                <div className="bg-white/50 backdrop-blur-sm rounded-2xl p-6 border border-white/30">
                  ...
                  <div className="flex items-center gap-3 mb-4">
                    <span className={`px-3 py-1 rounded-full text-sm font-semibold border-2 ${getStatusColor(currentVideo.status)}`}>
                  ...
                  {currentVideo.note && (
                    <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-4 rounded-xl border border-blue-100/50">
                      <p className="text-gray-700 font-medium">{currentVideo.note}</p>
                    </div>
                  )}
                </div>
              </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mb-2">
                      <span className={`px-2 py-1 rounded-full text-xs font-semibold border ${getStatusColor(video.status)}`}>
                        {video.status.replace('-', ' ')}
                      </span>
                      <span className="text-xs text-gray-500">{formatDate(new Date(video.addedAt))}</span>
                    </div>
                    {video.note && (
                      <p className="text-xs text-gray-600 truncate bg-gray-50/50 px-2 py-1 rounded-md">{video.note}</p>
                    )}
                  </div>
